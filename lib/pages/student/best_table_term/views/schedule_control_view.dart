...
class ScheduleControlView extends ConsumerWidget {
  ...
  Widget _buildGeneratorOptions(
    ...
    final double fontSize = scaleConfig.tabletScaleText(11);
    final double minHeight = scaleConfig.tabletScale(36);
    final double minWidth = scaleConfig.widthPercentage(0.20);
        ...
        children: [
          Row(
            ...
            children: [
              ToggleButtons(
                isSelected:
                    hourOptions.map((h) => selectedMaxHours == h).toList(),
                onPressed:
                    (index) => controller.setMaxHours(hourOptions[index]),
                color: secondaryTextColor,
                selectedColor: AppColors.primary,
                // ignore: deprecated_member_use
                fillColor: AppColors.primary.withOpacity(0.2),
          ...
          Row(
            ...
            children: [
              ToggleButtons(
                ...
                borderRadius: BorderRadius.circular(scaleConfig.scale(8)),
                constraints: BoxConstraints(
                  minWidth: scaleConfig.widthPercentage(0.40),
                  minHeight: minHeight,
                ),
                children: [
                  Text(
